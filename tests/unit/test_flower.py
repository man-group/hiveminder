...
def test_can_convert_flower_to_json():
    assert Flower(sentinel.x, sentinel.y, DEFAULT_GAME_PARAMETERS, sentinel.potency, sentinel.visits, sentinel.expires).to_json() == [sentinel.x, sentinel.y, DEFAULT_GAME_PARAMETERS._asdict(), sentinel.potency, sentinel.visits, sentinel.expires]


def test_can_read_flower_from_json():
    assert Flower.from_json([sentinel.x, sentinel.y, DEFAULT_GAME_PARAMETERS._asdict(), sentinel.potency, sentinel.expires]) == Flower(sentinel.x, sentinel.y, DEFAULT_GAME_PARAMETERS, sentinel.potency, sentinel.expires)
